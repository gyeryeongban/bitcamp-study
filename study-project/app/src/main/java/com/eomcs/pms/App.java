...
public class App {
  ...
  static void addMember() {
    ...
    no[size] = Integer.parseInt(promptInt("번호? "));
  ...
  static void listMember() {
    ...
    pStartDate[pSize] = Date.valueOf(promptDate("시작일? "));


    pEndDate[pSize] = Date.valueOf(promptDate("종료일? "));
  ...
  static void addTask() {
    ...
    tNo[tSize] = Integer.parseInt(promptInt("번호? "));


    tContent[tSize] = promptString("내용? ");


    tDeadline[tSize] = Date.valueOf(promptDate("마감일? "));
    ...
    tStatus[tSize] = Integer.valueOf(promptInt("> "));
  ...
  static String promptInt(String title) {
    System.out.println(title);
    String input = keyboardScan.nextLine();
    return input;
  }

  static String promptDate(String title) {
    System.out.println(title);
    String input = keyboardScan.nextLine();
    return input;
  }
