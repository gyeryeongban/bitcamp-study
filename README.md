...
- 개발 관리가 쉬운 크기로 요구 사항을 쪼갤 수 있다.
- 보통 use-case 단위로 개발을 관리한다.
- 너무 큰 요구 사항은 관리가 어렵다.
- 너무 크기가 작은 요구 사항은 관리가 번거롭다.
...
- 분리를 통해 식별한 use-case는 업무가 아닌 경우가 있다.
- 여러 use-case에서 공통으로 수행해야 하는 작업을 이렇게 분리하면 개발 관리가 쉬워진다.
